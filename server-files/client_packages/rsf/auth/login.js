mp.events.add('ShowLoginForm', (login, params) => {
    ...
    mp.events.call('createBrowser', `rsf/assets/views/${login === true ? "login" : "register"}.html`, params);    // ['package://rsf/assets/views/login.html']);
});
